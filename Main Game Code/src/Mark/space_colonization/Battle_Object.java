...
public class Battle_Object {
	...
	private int crew;
	private int ammo;
	public Battle_Object(double hp)
	{
		name = "object";
	...
	public Battle_Object(String na)
	{
		name = na;
		qualities = new double[19];
		cost = 10;
	...
	public Battle_Object(String nameOfShip, double[] stats, int Cost, String display, int Crew, int am)
	{
		name = nameOfShip;
		qualities = stats;
		cost = Cost;
