...
//        defenders = new ArrayList<Flotilla>();
    ...
    private void loadAudio() {
        ...
        battles = new AudioNode[]{audio_battle1,audio_battle2,audio_battle3,audio_battle4};
        ...
        creates = new AudioNode[]{audio_onCreate1,audio_onCreate2,audio_onCreate3,audio_onCreate4};
        for(int i=0;i<battles.length;i++){
